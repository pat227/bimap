...
lib: $(libdir)bimap.ml $(libdir)bimap.mli $(libdir)bimap_multi.ml #$(libdir)bimap_multi.mli
	...
	ocamlbuild -classic-display -use-ocamlfind -j 1 -tag thread -tag principal -r -package 'base core_kernel core' -build-dir build -I src/lib -I src/main -I build/src/lib src/lib/bimap.cmx
	...
	ocamlbuild -classic-display -use-ocamlfind -j 1 -tag thread -tag principal -r -package 'base core_kernel core' -build-dir build -I src/lib -I src/main -I build/src/lib src/lib/bimap_multi.cma
	ocamlbuild -classic-display -use-ocamlfind -j 1 -tag thread -tag principal -r -package 'base core_kernel core' -build-dir build -I src/lib -I src/main -I build/src/lib src/lib/bimap_multi.cmo
	ocamlbuild -classic-display -use-ocamlfind -j 1 -tag thread -tag principal -r -package 'base core_kernel core' -build-dir build -I src/lib -I src/main -I build/src/lib src/lib/bimap_multi.cmx
	ocamlbuild -classic-display -use-ocamlfind -j 1 -tag thread -tag principal -r -package 'base core_kernel core' -build-dir build -I src/lib -I src/main -I build/src/lib src/lib/bimap_multi.a
